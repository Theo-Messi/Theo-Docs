...
华硕原厂固件即华硕路由器官方固件，其代号为 Asuswrt，官方固件可以在 <Pill icon="simple-icons:asus" name="华硕官方下载中心" link="https://www.asus.com.cn/support/Download-Center/" /> 下载到。
...
通常我们说到**梅林固件**，就是指**梅林原版固件**，梅林原版固件目前其版本号一般为 `386.x` ，如： `386.1` 、 `386.2_6` ，梅林原版固件的下载地址为：<Pill image="https://www.asuswrt-merlin.net/sites/default/files/Asuswrt-Merlin-smaller.png" name="梅林原版固件" link="https://www.asuswrt-merlin.net/" />

## G 版梅林固件

另外一位开发者：**gnuton 大神** <Pill :icon="{ icon: 'cib:github', color: { light: '#000', dark: '#fff' } }" name="G版梅林固件源码" link="https://github.com/gnuton/asuswrt-merlin.ng" />，在原版梅林代码的基础上，添加了更多机型的支持，最开始注意到他的项目是因为他做了 DSL-AX82U 的梅林固件。
