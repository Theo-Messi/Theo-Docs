...
![AdGuardHome](https://i.theovan.cn/docs/20231230203658.png)

**使用ubuntu x64 镜像**

![AdGuardHome](https://i.theovan.cn/docs/20231230203757.png)
...
![AdGuardHome](https://i.theovan.cn/docs/20231230204830.png)
...
![AdGuardHome](https://i.theovan.cn/docs/20231230205626.png)

### 常规设置 部分

![AdGuardHome](https://i.theovan.cn/docs/20231230205838.png)
...
![AdGuardHome](https://i.theovan.cn/docs/20231230210932.png)

### 接口 - Lan - 高级设置 - DHCP - 高级设置

**DHCP选项:** `6,+ AdGuardHome ip`

![AdGuardHome](https://i.theovan.cn/docs/20231230211121.png)

### 接口 - Wan - 高级设置

**使用自定义的DNS服务器:** `AdGuardHome ip`

![AdGuardHome](https://i.theovan.cn/docs/20231230211412.png)

### 首先使虚拟机处于关闭状态,然后点击编辑

修改内存为 25 GB 保存并开启虚拟机

![AdGuardHome](https://i.theovan.cn/docs/20231231142111.png)
...
![AdGuardHome](https://i.theovan.cn/docs/20231231142451.png)
