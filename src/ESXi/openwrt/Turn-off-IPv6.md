...
![](https://i.theovan.cn/docs/v6-1.nuexini)
...
![](https://i.theovan.cn/docs/v6-2.nuexini)

### **高级设置**

- 把 **IPv6 分配长度** 选择 **已禁用**

![](https://i.theovan.cn/docs/v6-3.nuexini)

### 取消勾选 - **使用内置的 IPv6 管理**

![](https://i.theovan.cn/docs/v6-4.nuexini)

### **保存**

![](https://i.theovan.cn/docs/v6-5.nuexini)
...
![](https://i.theovan.cn/docs/v6-7.nuexini)
...
![](https://i.theovan.cn/docs/v6-9.nuexini)
...
![](https://i.theovan.cn/docs/v6-11.webp)

- 下图为原版 **OpenWrt > 网络 > DHCP/DNS > 高级设置**

![](https://i.theovan.cn/docs/v6-12.nuexini)
