...
![Netflix](https://i.theojs.cn/docs/202406111420455.png)
...
<Box :items="[
  { link: 'https://ihezu.love/UKTer6', icon: 'https://i.theojs.cn/logo/netflix.svg', name: 'Netflix 账号', tag: '合租平台' },
  { link: '/serve/airport/FlyingBird', icon: 'https://i.theojs.cn/logo/netflix.svg', name: 'Netflix 线路', tag: '流媒体解锁' }
  ]"/>
...
<Links :items="[
{ name: '或在 APKPURE 上下载最新版 Netflix APK', icon:'https://i.theojs.cn/logo/netflix.svg',link: 'https://apkpure.com/netflix/com.netflix.mediaclient' },
]" />
